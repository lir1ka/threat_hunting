...
Создадим круговую диаграмму для анализа распределения событий по
диапазонам размера
...
Создадим столбчатую диаграмму для выявления наиболее “активных”
источников по суммарному объёму переданных данных сп
...
Создадим точечную диаграмму для анализа поведения источников: сколько
уникальных назначений и портов использует каждый src.
...
Я познакомился с YandexDatalens, научился делать чарты и строить чарты,
дашборд.
